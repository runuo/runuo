...
namespace Server.Mobiles
{
	...
	public class GokturOutrider : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Orc; } }

		[Constructable]
		public GokturOutrider() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.01, 0.005 )
		{
		...
		public GokturOutrider( Serial serial ) : base( serial )
		{
		}
