...
{
	public class LordLava : BaseChampion
	{
		...
		[Constructable]
		public LordLava() : base( AIType.AI_Mage, FightMode.Evil )
		{
			Body = 175;
			Name = "Lord Oaks";
		...
		public void SpawnDaemons( Mobile target )
		{
			Map map = this.Map;
			...
			int newDaemons = Utility.RandomMinMax( 3, 6 );

			for ( int i = 0; i < newDaemons; ++i )
			{
		...
		public LordLava( Serial serial ) : base( serial )
		{
		}
